...
@Component({
  selector: 'app-asset-commercial',
  templateUrl: './asset-commercial.component.html',
  styleUrls: ['./asset-commercial.component.css']
})

export class AssetCommercialComponent implements OnInit {
  @ViewChild(DatatableComponent) table: DatatableComponent;

  loggedUserId: any = '';

  faPlus = faPlus;
  heading = 'Commercial Flats';
  subheading = 'List of all commercial flats.';
  ...
  getAssets() {
    this.apiService.get('/api/asset/propertyFull', 'commercial').subscribe((response: any) => {
      if (response.status === 200) {
