...
@Component({
  selector: 'app-owner-commercial',
  templateUrl: './owner-commercial.component.html',
  styleUrls: ['./owner-commercial.component.css']
})

export class OwnerCommercialComponent implements OnInit {
  @ViewChild(DatatableComponent) table: DatatableComponent;
  loggedUserId: any = '';
  faPlus = faPlus;
  heading = 'Commercial Owner List';
  subheading = 'List of all commercial owners.';
  ...
  getOwners() {
    this.apiService.get('/api/lessor/property', 'commercial').subscribe((response: any) => {
